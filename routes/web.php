...
Route::group(['middleware' => 'auth'], function () {
	...
	//Search
	Route::post('/search', 'EditionsController@search');
	...
	Route::post('/report/reportei','ReportController@reportei')->name('report.reportei');
	Route::post('/report/consult1','ReportController@consult1')->name('report.consult1');
	Route::get('/report/consult1', ['as' => 'report.printpdf', 'uses' => 'ReportController@printPDF']);
