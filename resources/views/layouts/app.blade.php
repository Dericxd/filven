...
<head>
    ...
    <link href="{{ asset('material') }}/css/material-dashboard-pro-laravel.css?v=2.1.2" rel="stylesheet"/>

    <!-- DataTable -->
    <link href="{{ asset('plugins') }}/datatable/datatables.css" rel="stylesheet"/>
...
<!-- DataTable -->
{{--        <script src="{{ asset('plugins') }}/datatable/datables.js"></script>--}}
{{--        <script src="{{ asset('plugins') }}/datatable/jQuery-3.3.1/jquery-3.3.1.js"></script>--}}
{{--        <script src="{{ asset('plugins') }}/datatable/jQuery-3.3.1/jquery-3.3.1.min.js"></script>--}}
